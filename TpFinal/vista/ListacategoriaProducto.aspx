<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ListacategoriaProducto.aspx.cs" Inherits="vista.ListacategoriaProducto" %>
    ...
    <div class="container mt-4" style="height: 198px">
        ...
        <div class="row justify-content-end">
            <div class="col-md-4 text-end">
               <a href="AltaCategoriaProducto.aspx" class="btn btn-primary">Nueva Categoría</a>
            </div>
        </div>
