<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AltaCompra.aspx.cs" Inherits="vista.AltaCompra" %>
        ...
        <div class="row justify-content-md-center ">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="DetalleComprobanteCompra.aspx">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="input-group mb-3">
                                <span class="input-group-text text-secondary" id="lblProveedor">Proveedor</span>
                                <asp:TextBox runat="server" CssClass="form-control" ID="TxtProveedor" Enabled="false"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="ReqCliente" ControlToValidate="TxtProveedor"
                                    ValidationGroup="CompraGroup" runat="server"><h4 class="ms-2 text-danger"><i title="Campo obligatorio" class=" bi bi-exclamation-circle"></i></h4></asp:RequiredFieldValidator>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="input-group mb-3">
                                <span class="input-group-text text-secondary" id="lblPdv">Punto de Venta</span>
                                <asp:TextBox runat="server" CssClass="form-control" ID="TxtPdv" Enabled="false"></asp:TextBox>
                        ...
                        <div class="col-md-3">
                            <div class="input-group mb-3">
                                ...
                                <asp:TextBox runat="server" CssClass="form-control" ID="TxtNumero" Enabled="false"></asp:TextBox>
            ...
            <div class="card col-md-10">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="DetalleProductosCompra.aspx">
                                <h4 class="text-info"><i title="Editar" class="bi bi-pencil-square"></i></h4>
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body text-center">
                    <%if (detProductosCompra.Count == 0)
                        { %>
                    <h5 class="card-title">Aún no has añadido Productos</h5>
                    <a href="DetalleProductosCompra.aspx" class="btn btn-primary">Agregar productos</a>
                    <%}
                        else
                        { %>
                ...
                <div class="card-footer text-end">
                    ...
                    <asp:Button runat="server" ID="btnAceptar" CssClass="btn btn-success" Text="Aceptar" OnClick="btnAceptar_Click" CausesValidation="true" ValidationGroup="CompraGroup" />
                    <%} %>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 text-center">
                    <asp:ValidationSummary runat="server" DisplayMode="BulletList" CssClass="text-danger fs-4" HeaderText="Debe completar los campos marcados" ValidationGroup="CompraGroup" />
                </div>
            </div>
