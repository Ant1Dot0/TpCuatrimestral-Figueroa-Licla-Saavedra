<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DetalleProductosVenta.aspx.cs" Inherits="vista.DetalleProductosVenta" %>
        ...
        <div class="row justify-content-between mb-2">
            <div class="col-md-3 text-start">
                <div class="input-group">
                    <span class="input-group-text" id="lblTotal">TOTAL A PAGAR</span>
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <asp:GridView ID="gvProductos" runat="server" DataKeyNames="codigo" CssClass="table table-info" AutoGenerateColumns="false"
                                OnSelectedIndexChanged="gvProductos_SelectedIndexChanged" OnPageIndexChanged="gvProductos_SelectedIndexChanged"
                                AllowPaging="true">
                                <Columns>
